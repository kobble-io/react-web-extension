![Add authentication and monetization to your Chrome Extension in minutes using Kobble](https://github.com/kobble-io/react-web-extension/blob/main/.readme/banner.png?raw=true)
